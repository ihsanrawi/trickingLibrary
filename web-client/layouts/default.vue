  ...
  <v-app dark>
    <v-app-bar app dense>
      ...
      <v-skeleton-loader class="mx-1" :loading="loading" transition="fade-transition" type="button" >
        <v-menu offset-y v-if="authenticated">
          ...
          <v-list>
            <v-list-item @click="$router.push('/profile')">
              <v-list-item-title><v-icon left>mdi-account-circle</v-icon>Profile</v-list-item-title>
            </v-list-item>
        ...
        <v-btn depressed outlined v-else @click="$auth.signinRedirect()"><v-icon left>mdi-account-circle-outline</v-icon>Log In</v-btn>
      </v-skeleton-loader>
